...
#
# Commands:
#   applaus|bravo|slow clap - Krijg applaus
#   sarcastisch applaus|clap - Krijg sarcastisch applaus
#
# Author:
#   joshfrench
...
module.exports = (robot) ->
	robot.hear /\b(applaus|bravo|sarcastisch applaus|(slow|sarcastisch) clap)\b/i, (msg) ->
		type = if (/sarcastisch/i).test(msg.message.text) then images.insincere else images.sincere
